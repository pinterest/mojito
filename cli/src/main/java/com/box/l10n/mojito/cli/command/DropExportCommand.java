...
public class DropExportCommand extends Command {
  ...
  private ExportDropConfig getExportDropConfig(RepositoryRepository repository) {
  ...
  public void execute() throws CommandException {
    ...
    if (typeParam == ExportDropConfig.TypeEnum.REVIEW || shouldCreateDrop(repository)) {
      ExportDropConfig exportDropConfig = getExportDropConfig(repository);

      try {
        exportDropConfig = this.dropClient.exportDrop(exportDropConfig);
      } catch (ApiException e) {
        throw new CommandException(e.getMessage(), e);
      }
