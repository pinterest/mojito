...
import com.box.l10n.mojito.apiclient.PollableTaskWsApi;
...
public class PollableTaskWsApiProxy {
   ...
   * @throws com.box.l10n.mojito.apiclient.exception.PollableTaskException
   */
   ...
   * Waits for {@link PollableTask} to be all finished (see {@link PollableTask#isAllFinished() }).
   *
   * @param pollableId the {@link com.box.l10n.mojito.apiclient.model.PollableTask#getId()}
