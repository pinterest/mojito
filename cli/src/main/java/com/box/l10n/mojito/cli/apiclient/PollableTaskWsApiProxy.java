...
import com.box.l10n.mojito.cli.apiclient.exception.PollableTaskExecutionException;
import com.box.l10n.mojito.cli.apiclient.exception.PollableTaskTimeoutException;
import com.box.l10n.mojito.cli.model.ErrorMessage;
...
public class PollableTaskWsApiProxy {
  ...
  @Autowired private PollableTaskWsApi pollableTaskClient;
   ...
   * @throws com.box.l10n.mojito.cli.apiclient.exception.PollableTaskException
   */
  ...
  public void waitForPollableTask(
    ...
    while (pollableTask == null || !pollableTask.isAllFinished()) {
      ...
      pollableTask = this.pollableTaskClient.getPollableTaskById(pollableId);
