...
public class EvolveServiceTest extends ServiceTestBase {
  ...
  @Autowired EvolveService2 evolveService2;
  ...
  private void initData(ZonedDateTime updatedOn) {
    ...
    courseDTO2.setId(2);
    courseDTO2.setTranslationStatus(TranslationStatusType.READY_FOR_TRANSLATION);
    courseDTO2.setUpdatedOn(ZonedDateTime.now().minusDays(1));*/
  ...
  @Test
  public void testSyncWithOneInTranslationCourseAndOneRepositoryLocale()
    ...
    Asset asset =
        this.assetService
            .findAll(repository.getId(), "1.xliff", false, false, branch.getId())
            .getFirst();
  ...
  public void testSync()
    ...
    this.initData2(ZonedDateTime.now().minusDays(1));
    Locale esLocale = this.localeService.findByBcp47Tag("es");
    RepositoryLocale esRepositoryLocale = new RepositoryLocale();
    esRepositoryLocale.setLocale(esLocale);
    Repository repository =
    ...
    assertEquals((int) integerCaptor.getValue(), 2);
    ...
    assertEquals(2, (int) this.integerCaptor.getValue());
