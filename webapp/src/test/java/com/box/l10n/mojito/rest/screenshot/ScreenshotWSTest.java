...
import com.box.l10n.mojito.cli.apiclient.model.TMTextUnit;
...
public class ScreenshotWSTest extends WSTestBase {
  ...
  public void testUploadScreenshots() throws RepositoryNameAlreadyUsedException {
    ...
    com.box.l10n.mojito.cli.apiclient.model.Locale locale =
        new com.box.l10n.mojito.cli.apiclient.model.Locale();
    locale.setId(localefrFR.getId());
    locale.setBcp47Tag(localefrFR.getBcp47Tag());

    ScreenshotRun screenshotRun = new ScreenshotRun();
    com.box.l10n.mojito.cli.apiclient.model.Repository r =
        new com.box.l10n.mojito.cli.apiclient.model.Repository();
    ...
    com.box.l10n.mojito.cli.apiclient.model.Screenshot screenshot1 =
        new com.box.l10n.mojito.cli.apiclient.model.Screenshot();
    screenshot1.setName("screenshot1");
    screenshot1.setLocale(locale);
    screenshotRun.getScreenshots().add(screenshot1);

    com.box.l10n.mojito.cli.apiclient.model.Screenshot screenshot2 =
        new com.box.l10n.mojito.cli.apiclient.model.Screenshot();
  ...
  public void testAddManualScreenshot() throws RepositoryNotFoundException {
    ...
    com.box.l10n.mojito.cli.apiclient.model.Branch branch1 =
        new com.box.l10n.mojito.cli.apiclient.model.Branch();
    ...
    com.box.l10n.mojito.cli.apiclient.model.Screenshot screenshot =
        new com.box.l10n.mojito.cli.apiclient.model.Screenshot();
    screenshot.setName(UUID.randomUUID().toString());
    screenshot.setLocale(new com.box.l10n.mojito.cli.apiclient.model.Locale());
    ...
    com.box.l10n.mojito.cli.apiclient.model.ScreenshotTextUnit screenshotTextUnit =
        new com.box.l10n.mojito.cli.apiclient.model.ScreenshotTextUnit();
    ...
    com.box.l10n.mojito.cli.apiclient.model.ScreenshotTextUnit screenshotTextUnit2 =
        new com.box.l10n.mojito.cli.apiclient.model.ScreenshotTextUnit();
