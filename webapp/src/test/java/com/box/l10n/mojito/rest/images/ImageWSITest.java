...
import com.box.l10n.mojito.apiclient.FixedImageWsApi;
...
public class ImageWSITest extends WSTestBase {
  ...
  @Autowired FixedImageWsApi imageClient;
  ...
  public void testImageNameOneWord() {
    ...
    imageClient.uploadImage("some test".getBytes(StandardCharsets.UTF_8), imageName);
