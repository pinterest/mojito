...
/**
 * Custom hook for managing branch filters state with session storage persistence
 *
 * @returns A tuple containing the current filter state and setter functions
 */
