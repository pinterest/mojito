...
/**
 * Sends warning messages to the specified warning channel on Slack. Selects default Slack client
 * specified in app properties, if none specified the first Slack Client is used. The channel name
 * for warnings must be placed in the app properties under: l10n.slackWarningChannel
 *
 * @author mattwilshire
 */
@Component
