...
public class ObjectMapperTest {
  ...
  static final ZonedDateTime A_DATE_TIME =
      ZonedDateTime.of(2023, 12, 06, 15, 22, 5, 123_456_789, ZoneId.systemDefault());
  ...
  public void serialization() {
    ...
    Assertions.assertThat(objectMapper.writeValueAsStringUnchecked(pojo))
        .isEqualTo(SERIALIZED_DATE_TIME);
  }
  ...
  public void deserialization() {
    ...
    Assertions.assertThat(pojo.getZonedDateTime())
        .isEqualTo(ZonedDateTime.of(2023, 12, 06, 15, 22, 5, 123_000_000, ZoneId.systemDefault()));
  }
